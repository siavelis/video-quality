...
inDir = 'C:\\Users\\prs\\repos\\semantic_image_inpainting\\testimages'
imgExt = 'png'
outDir = 'C:\\Users\\prs\\repos\\semantic_image_inpainting\\completions'
prefix = ''
...
for imgfilename in imgfilenames:
    ...
    ref_moodokiFile = outDir + "\\inpaint_" + fileName
    ...
    tuple_ = [fileName, None, _psnrMoodoki]
    psnrs.append(tuple_)
    # print(tuple_)
    ...
    tuple_ = [fileName, None, _ssimMoodoki]
    ssims.append(tuple_)
    # print(tuple_)
    # break
    i = i + 1
